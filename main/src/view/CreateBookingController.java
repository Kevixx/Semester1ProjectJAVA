...
public class CreateBookingController {
    ...
    @FXML
    private RadioButton lateCheckInYES;
    @FXML
    private RadioButton lateCheckInNO;
    @FXML
    private RadioButton extraBedYES;
    @FXML
    private RadioButton extraBedNO;
    @FXML
    ...
    @FXML
    private ChoiceBox<Room> roomSelection;
    @FXML
...
//or Region
                ...
                try {
                    ...
                    loader.setLocation(getClass().getResource("bookingsaved.fxml"));
                    root = loader.load();
